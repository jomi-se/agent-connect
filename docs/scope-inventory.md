...
| Report effective runtime posture                    | Security slice    | SDK distinguishes verified, provider-backed, attested, and self-reported properties            |
...
- The reference runtime's default remote-application profile uses an empty
  ...
  policy selection, non-expansion, and honest posture reporting.
