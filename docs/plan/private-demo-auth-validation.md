...
export AGENT_CONNECT_PUBLIC_ENDPOINT=https://gateway.example:8443
...
curl -fsS https://gateway.example:8443/healthz
```
...
7. Open
   `https://gateway.example:8443/v1/grants`, revoke the Canvas
