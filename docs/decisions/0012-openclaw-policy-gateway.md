...
[ADR 0014](0014-stock-openclaw-scoped-proxy.md) selects a smaller authorization
...
Codex support based on a built-in-loop test. the owner selected the built-in
