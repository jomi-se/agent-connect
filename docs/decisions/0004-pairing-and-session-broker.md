...
gateway but does not independently authenticate an arbitrary first-contact
destination to the application. The target mutual-identity design is recorded
in `docs/research/2026-07-14-mutual-runtime-identity.md`: enroll the gateway
...
application capabilities to both gateway and browser keys. This clarifies the
