...
host (tailnet `100.64.0.10`, RFC1918 `192.0.2.10`, loopback `127.0.0.1`) and
fetching a logging server:

| Initiator | Target | Result |
| --- | --- | --- |
| `http://100.64.0.10:9099` | `http://192.0.2.10:9098` | ordinary preflight, no PNA/LNA request header, fetch succeeded |
| `http://100.64.0.10:9099` | `http://127.0.0.1:9098` | request never reached the server; hung pending |
| `http://127.0.0.1:9099` | `http://192.0.2.10:9098` | request never reached the server; hung pending |
