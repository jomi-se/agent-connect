...
const serviceEnv = {
  ...
  OMNIGENT_RUNNER_ENV_PASSTHROUGH:
    "AGENT_CONNECT_ACP_TRANSCRIPT,AGENT_CONNECT_DETERMINISTIC_TOOL_ARGUMENTS,AGENT_CONNECT_DETERMINISTIC_TOOL_NAME,HOME,PATH,TMPDIR,XDG_CACHE_HOME,XDG_CONFIG_HOME,XDG_DATA_HOME",
  NO_BROWSER: "1",
