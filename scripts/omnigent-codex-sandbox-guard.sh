...
export CODEX_PATH="/workspace/agent-connect/node_modules/@openai/codex-linux-arm64/vendor/aarch64-unknown-linux-musl/bin/codex"

exec /usr/bin/node /workspace/agent-connect/node_modules/@agentclientprotocol/codex-acp/dist/index.js
