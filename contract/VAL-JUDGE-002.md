# VAL-JUDGE-002: The disposable judge demo is isolated from personal state
...
artifacts are copied into image layers. The demo container runs as non-root with a
...
remote attestation. Processes inside the disposable demo container are not isolated
...
uses a clean browser profile until the public demo receives a distinct
hostname.
